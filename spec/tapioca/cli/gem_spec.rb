...
module Tapioca
  class GemSpec < SpecWithProject
    ...
    describe "cli::gem" do
      ...
      it "dealiases constant prefixes defined in another gem" do
        foo = mock_gem("foo", "0.0.1") do
          write("lib/foo.rb", <<~RB)
            module Foo; end
            F = Foo
        ...
        @project.require_mock_gem(foo, require: false)
        @project.require_mock_gem(bar, require: false)
        @project.require_mock_gem(baz, require: false)
        @project.bundle_install

        @project.tapioca("gem foo bar baz")
        ...
        assert_project_file_equal("sorbet/rbi/gems/baz@0.0.1.rbi", <<~RBI)
          # typed: true
          ...
          Foo::Bar::Bz = Foo::Bar::Baz
        RBI
      end

      it "dealiases constant prefixes defined in the same gem" do
        foo = mock_gem("foo", "0.0.1") do
          write("lib/foo.rb", <<~RB)
            module Foo; end
            F = Foo
